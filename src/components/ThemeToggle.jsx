...
const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-yellow-400 hover:scale-110 transition-all active:scale-95 border border-gray-200 dark:border-gray-700"
